...
//             style={{ fontFamily: "Cantata one" }}
//           >
//             <button className="px-10 py-4 w-995 bg-transparent border-2 border-white text-white font-bold  hover:bg-white hover:text-gray-900 transition-all duration-300">
...
//                   <h3
//                     className="text-md text-gray-800 group-hover:text-teal-600 transition-colors"
//                     style={{ fontFamily: "Cantata one" }}
//                   >
//                     {instrument.name}
//                   </h3>
